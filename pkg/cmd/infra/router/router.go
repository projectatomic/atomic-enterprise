...
const (
	routerLong = `Start an Atomic Enterprise router.

This command launches a router connected to your Atomic Enterprise master. The router listens for routes and endpoints
...
func NewCommandTemplateRouter(name string) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Start an Atomic Enterprise router",
		Long:  routerLong,
