...
import (
	...
	buildcontrollerfactory "github.com/projectatomic/atomic-enterprise/pkg/build/controller/factory"
	buildstrategy "github.com/projectatomic/atomic-enterprise/pkg/build/controller/strategy"
	buildgenerator "github.com/projectatomic/atomic-enterprise/pkg/build/generator"
	buildregistry "github.com/projectatomic/atomic-enterprise/pkg/build/registry/build"
	buildetcd "github.com/projectatomic/atomic-enterprise/pkg/build/registry/build/etcd"
	buildconfigregistry "github.com/projectatomic/atomic-enterprise/pkg/build/registry/buildconfig"
	buildconfigetcd "github.com/projectatomic/atomic-enterprise/pkg/build/registry/buildconfig/etcd"
	buildlogregistry "github.com/projectatomic/atomic-enterprise/pkg/build/registry/buildlog"
	"github.com/projectatomic/atomic-enterprise/pkg/build/webhook"
	"github.com/projectatomic/atomic-enterprise/pkg/build/webhook/generic"
	"github.com/projectatomic/atomic-enterprise/pkg/build/webhook/github"
	...
	configchangecontroller "github.com/projectatomic/atomic-enterprise/pkg/deploy/controller/configchange"
	deployerpodcontroller "github.com/projectatomic/atomic-enterprise/pkg/deploy/controller/deployerpod"
	deploycontroller "github.com/projectatomic/atomic-enterprise/pkg/deploy/controller/deployment"
	deployconfigcontroller "github.com/projectatomic/atomic-enterprise/pkg/deploy/controller/deploymentconfig"
	imagechangecontroller "github.com/projectatomic/atomic-enterprise/pkg/deploy/controller/imagechange"
	deployconfiggenerator "github.com/projectatomic/atomic-enterprise/pkg/deploy/generator"
	deployconfigregistry "github.com/projectatomic/atomic-enterprise/pkg/deploy/registry/deployconfig"
	deployconfigetcd "github.com/projectatomic/atomic-enterprise/pkg/deploy/registry/deployconfig/etcd"
	deployrollback "github.com/projectatomic/atomic-enterprise/pkg/deploy/registry/rollback"
	"github.com/projectatomic/atomic-enterprise/pkg/dns"
	imagecontroller "github.com/projectatomic/atomic-enterprise/pkg/image/controller"
	...
	"github.com/projectatomic/atomic-enterprise/pkg/image/registry/imagestreammapping"
	"github.com/projectatomic/atomic-enterprise/pkg/image/registry/imagestreamtag"
	accesstokenetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthaccesstoken/etcd"
	authorizetokenetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthauthorizetoken/etcd"
	clientetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthclient/etcd"
	clientauthetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthclientauthorization/etcd"
	projectcache "github.com/projectatomic/atomic-enterprise/pkg/project/cache"
	projectcontroller "github.com/projectatomic/atomic-enterprise/pkg/project/controller"
	projectproxy "github.com/projectatomic/atomic-enterprise/pkg/project/registry/project/proxy"
	projectrequeststorage "github.com/projectatomic/atomic-enterprise/pkg/project/registry/projectrequest/delegated"
	routeallocationcontroller "github.com/projectatomic/atomic-enterprise/pkg/route/controller/allocation"
	routeetcd "github.com/projectatomic/atomic-enterprise/pkg/route/registry/etcd"
	routeregistry "github.com/projectatomic/atomic-enterprise/pkg/route/registry/route"
	clusternetworketcd "github.com/projectatomic/atomic-enterprise/pkg/sdn/registry/clusternetwork/etcd"
	hostsubnetetcd "github.com/projectatomic/atomic-enterprise/pkg/sdn/registry/hostsubnet/etcd"
	securitycontroller "github.com/projectatomic/atomic-enterprise/pkg/security/controller"
	"github.com/projectatomic/atomic-enterprise/pkg/security/mcs"
	...
	"github.com/projectatomic/atomic-enterprise/pkg/service"
	templateregistry "github.com/projectatomic/atomic-enterprise/pkg/template/registry"
	templateetcd "github.com/projectatomic/atomic-enterprise/pkg/template/registry/etcd"
	...
	buildclonestorage "github.com/projectatomic/atomic-enterprise/pkg/build/registry/clone/generator"
	buildinstantiatestorage "github.com/projectatomic/atomic-enterprise/pkg/build/registry/instantiate/generator"
	...
	clusterpolicystorage "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/clusterpolicy/etcd"
	clusterpolicybindingregistry "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/clusterpolicybinding"
	clusterpolicybindingstorage "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/clusterpolicybinding/etcd"
	clusterrolestorage "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/clusterrole/proxy"
	clusterrolebindingstorage "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/clusterrolebinding/proxy"
	policyregistry "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/policy"
	policyetcd "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/policy/etcd"
	policybindingregistry "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/policybinding"
	policybindingetcd "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/policybinding/etcd"
	resourceaccessreviewregistry "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/resourceaccessreview"
	rolestorage "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/role/policybased"
	rolebindingstorage "github.com/projectatomic/atomic-enterprise/pkg/authorization/registry/rolebinding/policybased"
	...
	serviceaccountcontrollers "github.com/projectatomic/atomic-enterprise/pkg/serviceaccounts/controllers"
	"github.com/projectatomic/atomic-enterprise/plugins/osdn"
	routeplugin "github.com/projectatomic/atomic-enterprise/plugins/route/allocation/simple"
)
