...
import (
	...
	buildlogregistry "github.com/projectatomic/appinfra-next/pkg/build/registry/buildlog"
	...
	configchangecontroller "github.com/projectatomic/appinfra-next/pkg/deploy/controller/configchange"
	deployerpodcontroller "github.com/projectatomic/appinfra-next/pkg/deploy/controller/deployerpod"
	deploycontroller "github.com/projectatomic/appinfra-next/pkg/deploy/controller/deployment"
	deployconfigcontroller "github.com/projectatomic/appinfra-next/pkg/deploy/controller/deploymentconfig"
	imagechangecontroller "github.com/projectatomic/appinfra-next/pkg/deploy/controller/imagechange"
	deployconfiggenerator "github.com/projectatomic/appinfra-next/pkg/deploy/generator"
	deployconfigregistry "github.com/projectatomic/appinfra-next/pkg/deploy/registry/deployconfig"
	deployconfigetcd "github.com/projectatomic/appinfra-next/pkg/deploy/registry/deployconfig/etcd"
	deployrollback "github.com/projectatomic/appinfra-next/pkg/deploy/registry/rollback"
	"github.com/projectatomic/appinfra-next/pkg/dns"
	imagecontroller "github.com/projectatomic/appinfra-next/pkg/image/controller"
	...
	"github.com/projectatomic/appinfra-next/pkg/image/registry/imagestreammapping"
	...
	projectcontroller "github.com/projectatomic/appinfra-next/pkg/project/controller"
	projectproxy "github.com/projectatomic/appinfra-next/pkg/project/registry/project/proxy"
	projectrequeststorage "github.com/projectatomic/appinfra-next/pkg/project/registry/projectrequest/delegated"
	routeallocationcontroller "github.com/projectatomic/appinfra-next/pkg/route/controller/allocation"
	routeetcd "github.com/projectatomic/appinfra-next/pkg/route/registry/etcd"
	routeregistry "github.com/projectatomic/appinfra-next/pkg/route/registry/route"
	clusternetworketcd "github.com/projectatomic/appinfra-next/pkg/sdn/registry/clusternetwork/etcd"
	hostsubnetetcd "github.com/projectatomic/appinfra-next/pkg/sdn/registry/hostsubnet/etcd"
	securitycontroller "github.com/projectatomic/appinfra-next/pkg/security/controller"
	...
	"github.com/projectatomic/appinfra-next/pkg/service"
	templateregistry "github.com/projectatomic/appinfra-next/pkg/template/registry"
	templateetcd "github.com/projectatomic/appinfra-next/pkg/template/registry/etcd"
	...
	clusterpolicystorage "github.com/projectatomic/appinfra-next/pkg/authorization/registry/clusterpolicy/etcd"
	clusterpolicybindingregistry "github.com/projectatomic/appinfra-next/pkg/authorization/registry/clusterpolicybinding"
	clusterpolicybindingstorage "github.com/projectatomic/appinfra-next/pkg/authorization/registry/clusterpolicybinding/etcd"
	...
	resourceaccessreviewregistry "github.com/projectatomic/appinfra-next/pkg/authorization/registry/resourceaccessreview"
	...
	serviceaccountcontrollers "github.com/projectatomic/appinfra-next/pkg/serviceaccounts/controllers"
	"github.com/projectatomic/appinfra-next/plugins/osdn"
	routeplugin "github.com/projectatomic/appinfra-next/plugins/route/allocation/simple"
)
