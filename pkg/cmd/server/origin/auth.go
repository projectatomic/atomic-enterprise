...
import (
	...
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/challenger/placeholderchallenger"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/password/allowanypassword"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/password/basicauthpassword"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/password/denypassword"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/password/htpasswd"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/request/basicauthrequest"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/request/headerrequest"
	"github.com/projectatomic/appinfra-next/pkg/auth/authenticator/request/unionrequest"
	...
	"github.com/projectatomic/appinfra-next/pkg/auth/oauth/external/github"
	"github.com/projectatomic/appinfra-next/pkg/auth/oauth/external/google"
	...
	"github.com/projectatomic/appinfra-next/pkg/auth/oauth/registry"
	"github.com/projectatomic/appinfra-next/pkg/auth/server/csrf"
	"github.com/projectatomic/appinfra-next/pkg/auth/server/grant"
