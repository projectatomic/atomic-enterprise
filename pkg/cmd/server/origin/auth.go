...
import (
	...
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/challenger/passwordchallenger"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/challenger/placeholderchallenger"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/password/allowanypassword"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/password/basicauthpassword"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/password/denypassword"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/password/htpasswd"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/request/basicauthrequest"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/request/headerrequest"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/request/unionrequest"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/authenticator/request/x509request"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/oauth/external"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/oauth/external/github"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/oauth/external/google"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/oauth/external/openid"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/oauth/handlers"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/oauth/registry"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/server/csrf"
	"github.com/projectatomic/atomic-enterprise/pkg/auth/server/grant"
	...
	accesstokenregistry "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthaccesstoken"
	accesstokenetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthaccesstoken/etcd"
	authorizetokenregistry "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthauthorizetoken"
	authorizetokenetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthauthorizetoken/etcd"
	clientregistry "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthclient"
	clientetcd "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthclient/etcd"
	clientauthregistry "github.com/projectatomic/atomic-enterprise/pkg/oauth/registry/oauthclientauthorization"
