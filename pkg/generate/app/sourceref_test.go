...
func TestFromGitURL(t *testing.T) {
	...
	srcRef, err := gen.FromGitURL("git@github.com:projectatomic/atomic-enterprise.git#test_branch", "")
	if err != nil {
	...
	if srcRef.URL.String() != "git@github.com:projectatomic/atomic-enterprise.git" {
